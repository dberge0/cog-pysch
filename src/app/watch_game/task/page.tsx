...
const FlappyBird: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      // router.push('/new-path'); // Redirect to the new path
    }, 30000);
