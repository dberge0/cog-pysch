...
const FlappyBird: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      router.push('/reading_task/results'); // Redirect to the new path
    }, 30000);
