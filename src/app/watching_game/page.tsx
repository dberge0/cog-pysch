      ...
      <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100">
        <div className="max-w-xl p-4 px-8 pt-4 bg-white shadow-md rounded-lg">
          <div className="mb-4">
            ...
            In this experiment, you will participate in two trials. You have selected watching a game as your primary task, which you will perform in both trials. Once you select proceed, you will watch a 30 second Subway Surfers video clip. Make sure to pay attention to the movements the Subway Surfer is making! In each trial, you will also perform a secondary task. One secondary task is bouncing the ball that you see on the target in front of you. The other is repeatedly handwriting “My name is ___” , neatly within the lines on the sheet of paper in front of you. Please choose your first secondary task, which you will start as soon as you proceed to starting the primary task. You will perform the other secondary task in the second trial.
            </p>
          </div>
          <div className="px-44"> 
          <div className="pb-2">
