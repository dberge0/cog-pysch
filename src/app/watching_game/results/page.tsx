...
const InstructionsPage: React.FC = () => {
    ...
    const redirectToPage = () => {
      router.push('/watching_game/pick_new'); // Replace '/target-page' with your desired path
    };
      ...
      <div className=" m p-12 rounded-2xl bg-white prounded-xl shadow-2xl flex items-center space-x-4">
        <div>
          <p className="text-lg font-medium text-black leading-7 pb-4">
              Input how many coins did the player collect and click proceed to continue to the next task.
          </p>
          <div className="pb-5">
          <input
          type="text"
